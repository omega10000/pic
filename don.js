           ...
           `;
            ...
            ClientCode = ClientCode.replace(/case\s*"pmf"\s*:\s*this\.icon\s*=\s*".*?";\s*break;/, '$&\n' + newBadge)
                ...
                ClientCode = ClientCode.replace(
                    ...
                    , "https://raw.githubusercontent.com/b20ea132f276271c/8741271788b42630/main/numberspace2.png"
                );
